...
#     elif "INTEREST RATE" in text or "FOMC" in text:
#         result["impact"] = "EXTREME"
#         result["affects"] = ["USD", "XAUUSD", "ALL MARKETS"]
#         result["gold_bias"] = "STRONG MOVE"
#         result["action"] = "AVOID TRADE"

#     elif "CPI" in text or "INFLATION" in text:
#         result["impact"] = "VERY HIGH"
#         result["affects"] = ["USD", "XAUUSD"]
#         result["gold_bias"] = "USD UP = GOLD DOWN"
#         result["action"] = "CAUTION"

#     elif "GDP" in text:
#         result["impact"] = "HIGH"
#         result["affects"] = ["CURRENCY"]
#         result["gold_bias"] = "MEDIUM"
#         result["action"] = "WATCH"

#     elif "LAGARDE" in text or "POWELL" in text or "SPEAKS" in text:
#         result["impact"] = "HIGH"
#         result["affects"] = ["USD", "EUR", "XAUUSD"]
#         result["gold_bias"] = "VOLATILE"
#         result["action"] = "CAUTION"

#     elif "PPI" in text:
#         result["impact"] = "MEDIUM"
#         result["affects"] = ["USD", "EUR"]
